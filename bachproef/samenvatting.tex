...
%  TODO na testfase: resultaten en conclusie aanvullen.
...
op het kerkhof van Sint-Gillis-Waas.
...
% TODO: aanvullen na testing

//todo resultaten testfase en conclusie
%De technische evaluatie toonde aan dat [RESULTATEN INVULLEN].
%De conclusie is dat AR-navigatie op begraafplaatsen technisch haalbaar is en
%[CONCLUSIE INVULLEN]. Aanbevelingen voor verdere ontwikkeling omvatten de
%integratie van OSM-paddata voor een geroute navigatielijn en een formele
%gebruikersstudie met testpersonen van diverse leeftijdsgroepen.
