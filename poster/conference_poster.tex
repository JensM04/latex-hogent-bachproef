...
\begin{document}
    \begin{frame}[t]{}
        ...
        \begin{columns}[T]
            ...
            \par\vspace{2mm}
            {\large\itshape\color{hogentcream!75!hogentdark}%
                Van een gefaalde zoektocht naar een graf gevonden in
                {\bfseries\color{white}minder dan 3 minuten}}
        ...
        \begin{columns}[T, totalwidth=\linewidth]
            ...
            \begin{tcolorbox}[postercard]
                ...
                \vspace{2.5mm}
                {\normalsize Het probleem is leeftijdsonafhankelijk: in onze test vond
                    \textbf{geen enkele} testpersoon het graf zonder hulp (Scenario A).
                    Beide haakten gefrustreerd af na vergeefs zoeken op jaartal en alfabet.}
            \end{tcolorbox}
            ...
            \begin{tcolorbox}[postercard]
                \secheading{2}{Wat bestaat er al? Wat mist?}
                ...
                \begin{tcolorbox}[colback=hogentcream2, colframe=hogentcream2, arc=2mm,
                    boxrule=0pt, left=4mm, right=4mm, top=2mm, bottom=2mm,
                    borderline west={1.4mm}{0pt}{hogentred}]
                    {\normalsize\textbf{\color{hogentred}De lacune:} geen onderzoek toetst AR
                        voor grafnavigatie in een emotionele buitenomgeving. AR vermindert de
                        noodzaak om de aandacht te verdelen en verhoogt het situationeel bewustzijn
                        (Zhao et al., 2025; Xu, 2018) -> net wat hier ontbreekt.}
                \end{tcolorbox}
            \end{tcolorbox}
            ...
            \begin{tcolorbox}[postercard]
                \secheading{4}{Onze oplossing: de POC}
                \begin{columns}[T, totalwidth=\linewidth]
