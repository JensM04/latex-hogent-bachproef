...
Om het onderzoek af te bakenen, wordt hieronder de hoofdonderzoeksvraag geformuleerd: 

\vspace{4em}
    \emph{Op welke manier kan digitalisatie, in combinatie met augmented reality, worden ingezet om de efficiëntie van het navigeren van een kerkhof te verbeteren?}
\vspace{4em}

Aanvullend, worden er nog een aantal deelvragen gesteld die het onderzoek verder ondersteunen:
...
\begin{itemize}
    ...
    \item Hoe kan een Proof of Concept getest en geëvalueerd worden?
\end{itemize}
